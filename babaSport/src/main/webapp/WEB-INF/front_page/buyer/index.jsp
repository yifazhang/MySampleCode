...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="orders.jsp" title="我的订单">我的订单</a></li>
			<li><a href="orders.jsp" title="退换货订单">退换货订单</a></li>
			<li><a href="orders.jsp" title="我的收藏">我的收藏</a></li>
			</ul>
		</div>
		...
		<div class="box bg_gray">
			...
			<li><a href="deliver_address.jsp" title="收货地址">收货地址</a></li>
			<li><a href="change_password.jsp" title="修改密码">修改密码</a></li>
			</ul>
		</div>
