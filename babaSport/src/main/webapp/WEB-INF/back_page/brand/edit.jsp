			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<img width="100" height="100" id="allImgUrl" src="${brand.imgUrl}"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="radio" name="isDisplay" value="1" <c:if test="${brand.isDisplay == true}">checked="checked"</c:if>/>可用
						<input type="radio" name="isDisplay" value="0" <c:if test="${brand.isDisplay == false}">checked="checked"</c:if>/>不可用
					</td>
				</tr>
			</tbody>
			<tbody>
