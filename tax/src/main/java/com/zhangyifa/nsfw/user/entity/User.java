package com.zhangyifa.nsfw.user.entity;
...
public class User implements Serializable {
    ...
    public User(String dept, String account, String name, String password, String headImg, boolean gender, String state, String mobile, String email, Date birthday, String memo) {
        this.dept = dept;
