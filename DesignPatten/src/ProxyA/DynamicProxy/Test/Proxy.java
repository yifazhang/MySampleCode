...
public class Proxy {
    ...
    public static Object newProxyInstance(Class infce, InvocationHandler h) throws Exception {
        ...
        String src = "package ProxyA.DynamicProxy.Test;" + rt +
                "import java.lang.reflect.Method;" + rt +
                "import ProxyA.DynamicProxy.InvocationHandler;" + rt +
                ...
                methodStr + rt +
                "}";
        String fileName = "/home/zhangyifa/Documents/java/code/MySampleCode/DesignPatten/src/ProxyA/DynamicProxy/Test/$Proxy1.java";
        ...
        Class c = ul.loadClass("ProxyA.DynamicProxy.Test.$Proxy1");
